      ...
      {!session && <Card className="p-5">
        <div className="grid gap-4 lg:grid-cols-2">
          ...
          <div className="space-y-4">
            <Field label="Safety profile" hint="The agent cannot change this after launch."><Select value={safetyProfile} onChange={(event) => { const value = event.target.value as typeof safetyProfile; setSafetyProfile(value); if (value !== 'authenticated_active') { setSshCredentialId(''); setWebCredentialId(''); setAllowStateChangingRequests(false) } }}><option value="observe_only">Observe only</option><option value="safe_remote">Safe remote</option><option value="authenticated_active">Authenticated active</option></Select></Field>
