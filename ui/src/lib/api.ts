...
export async function listCredentialProfiles(params: {
  ...
  if (params.include_inactive) search.set('include_inactive', 'true')
  const res = await fetch(`${API_URL}/credential-profiles?${search}`, { cache: 'no-store' })
  if (!res.ok) throw new Error(await getApiErrorMessage(res, 'Failed to load credential profiles'))
  return res.json()
}
...
export async function createCredentialProfile(
  ...
  const res = await fetch(`${API_URL}/credential-profiles`, {
    method: 'POST',
    headers: { 'Content-Type': 'application/json' },
    body: JSON.stringify(payload),
  })
...
export async function rotateCredentialProfile(
  ...
  const res = await fetch(`${API_URL}/credential-profiles/${encodeURIComponent(profileId)}/rotate`, {
    method: 'POST',
    headers: { 'Content-Type': 'application/json' },
    body: JSON.stringify(payload),
  })
...
export async function deactivateCredentialProfile(
  ...
  const res = await fetch(`${API_URL}/credential-profiles/${encodeURIComponent(profileId)}`, {
    method: 'DELETE',
  })
  if (!res.ok) throw new Error(await getApiErrorMessage(res, 'Failed to deactivate credential profile'))
  return res.json()
...
export async function listRequestCollections(
  ...
  const res = await fetch(`${API_URL}/request-collections?${search}`, { cache: 'no-store' })
  if (!res.ok) throw new Error(await getApiErrorMessage(res, 'Failed to load request collections'))
  return res.json()
}

export async function getRequestCollection(
  collectionId: string,
): Promise<RequestCollectionDetail> {
  const res = await fetch(
    `${API_URL}/request-collections/${encodeURIComponent(collectionId)}`,
    { cache: 'no-store' },
  )
  if (!res.ok) throw new Error(await getApiErrorMessage(res, 'Failed to load request collection'))
  return res.json()
}
...
export async function listRequestCollectionInventory(
  ...
  if (!res.ok) throw new Error(await getApiErrorMessage(res, 'Failed to load request inventory'))
  return res.json()
}
...
export async function createRequestCollection(payload: {
  ...
  const res = await fetch(`${API_URL}/request-collections`, {
    method: 'POST',
    headers: { 'Content-Type': 'application/json' },
    body: JSON.stringify(payload),
  })
  if (!res.ok) throw new Error(await getApiErrorMessage(res, 'Failed to upload request collection'))
  return res.json()
}
...
export async function upsertRequestCollectionEnvironment(
  ...
  if (!res.ok) throw new Error(await getApiErrorMessage(res, 'Failed to save collection environment'))
  return res.json()
}
...
export async function upsertRequestCollectionBinding(
  ...
  if (!res.ok) throw new Error(await getApiErrorMessage(res, 'Failed to bind request collection'))
  return res.json()
}
...
export async function upsertRequestCollectionSelection(
  ...
  if (!res.ok) throw new Error(await getApiErrorMessage(res, 'Failed to save request selection'))
  return res.json()
}
