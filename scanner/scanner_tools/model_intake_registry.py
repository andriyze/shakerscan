...
for _adapter in (
    ...
    ModelSourceAdapter(
        ...
        repository_manifest="unsupported",
        repository_snapshot="unsupported",
        authentication="operator_gateway_or_signed_https_export",
        notes=("Acquisition requires an HTTPS export URL bound to the exact OCI reference and expected digest.",),
    ),
    ModelSourceAdapter(
        id="mlflow",
        ...
        repository_snapshot="unsupported",
        authentication="operator_gateway_or_signed_https_export",
        notes=("Acquisition requires an HTTPS export URL bound to the exact MLflow reference and expected digest.",),
    ),
):
