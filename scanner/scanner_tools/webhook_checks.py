    ...
    for spec in endpoints or []:
        ...
        if isinstance(spec, str):
            ...
            if len(parts) == 2 and parts[0].upper() in (
                    "POST", "PUT", "GET", "PATCH", "DELETE", "OPTIONS", "HEAD"):
        ...
        # Webhook receivers are POST; never POST to an explicitly read-only route
        # (GET/HEAD/DELETE/OPTIONS). Method-unknown candidates are gated by the
        # webhook path shape below.
