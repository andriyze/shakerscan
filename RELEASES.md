...
| --- | --- | --- | --- | --- | --- |
| 0.8.2 | pending candidate | `shakerscan/shakerscan-scanner:0.8.2` (pending) | `shakerscan/shakerscan-api:0.8.2` (pending) | `shakerscan/shakerscan-ui:0.8.2` (pending) | `shakerscan/shakerscan-model-intake-signer:0.8.2` (pending) |
