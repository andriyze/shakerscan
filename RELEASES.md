...
| --- | --- | --- | --- | --- | --- |
| 0.8.4 | pending candidate | `shakerscan/shakerscan-scanner:0.8.4` | `shakerscan/shakerscan-api:0.8.4` | `shakerscan/shakerscan-ui:0.8.4` | `shakerscan/shakerscan-model-intake-signer:0.8.4` |
...
Version 0.8.3 is the current stable release; 0.8.4 is the pending candidate. Complete
