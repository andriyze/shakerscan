...
ShakerScan can add digest-pinned worker VPSs to one control plane. The supported 0.8.14 production
...
trust, but it is excluded from the 0.8.14 production support boundary until its own physical
...
- [ShakerScan 0.8.14 release notes](https://github.com/andriyze/shakerscan/blob/main/docs/releases/0.8.14.md)
