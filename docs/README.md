...
| [`release-2.3.0-plan.md`](release-2.3.0-plan.md) | 2.3.0 plan: one objective — raise real Juice Shop recall 4/9 → 6/9 with no DAST waiver; scheduler fix, auth-body synth, SPA route extraction; freeze everything else |
