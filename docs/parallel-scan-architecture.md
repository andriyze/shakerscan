...
campaign timeline follow-through, AI red-team cross-run campaign history, saved Model Intake trust
anchors, graph consumers, externalized evidence, and registry-driven proof contracts before adding
...
the remaining AI campaign gap is comparison/history across runs.
