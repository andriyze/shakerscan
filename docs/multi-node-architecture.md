...
**Status:** Design authority + implementation complete; 2.4.0 broker physical-acceptance renewal pending. The fan-out
...
and is explicitly outside the 2.4.0 supported deployment boundary. Redis Stream
