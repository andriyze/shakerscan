...
**Status:** Design authority + implementation complete; 2.3.6 broker physical-acceptance renewal pending. The fan-out
...
and is explicitly outside the 2.3.6 supported deployment boundary. Redis Stream
