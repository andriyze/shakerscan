...
**Status:** Design authority + implementation complete; 2.5.2 broker physical-acceptance renewal pending. The fan-out
...
and is explicitly outside the 2.5.2 supported deployment boundary. Redis Stream
