...
**Status:** Design authority + implementation complete; 2.3.4 broker physical-acceptance renewal pending. The fan-out
...
and is explicitly outside the 2.3.4 supported deployment boundary. Redis Stream
