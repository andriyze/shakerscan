...
**Status:** Design authority + implementation complete; 2.0.1 broker physical-acceptance renewal pending. The fan-out
...
and is explicitly outside the 2.0.1 supported deployment boundary. Redis Stream
