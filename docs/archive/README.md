...
Historical, point-in-time, or superseded docs kept for root-cause/QA history only. **None of these
...
|---|---|
| `verification-depth-plan.md` | Mechanisms shipped; residual recall/proven-ratio outcome now in proposed-next-steps §1 + benchmark gate |
