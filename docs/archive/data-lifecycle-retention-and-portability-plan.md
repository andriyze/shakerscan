# Archived data lifecycle, retention, deletion, export, and import plan

> **Historical implementation plan (archived 2026-08-29).** It mixes proposed phases with work
> completed during the 2.0 refactor. Use
> [`../data-lifecycle-retention-and-portability-plan.md`](../data-lifecycle-retention-and-portability-plan.md)
> for the current safety contract and remaining work.
