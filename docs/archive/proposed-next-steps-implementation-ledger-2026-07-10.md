...
> **ARCHIVED (2026-07-11).** This is the long-form implementation ledger as it stood on 2026-07-10.
> It contains stale point-in-time status claims. Use
> [`../proposed-next-steps.md`](../proposed-next-steps.md) for current status and ordering.
...
`docs/archive/t3mp3st-adoption-implementation-ledger-2026-07-10.md`,
...
`docs/archive/t3mp3st-adoption-implementation-ledger-2026-07-10.md` was folded into this roadmap as an
