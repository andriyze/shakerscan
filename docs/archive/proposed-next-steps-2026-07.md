# Archived July 2026 roadmap

> **Historical only (archived 2026-08-29).** Many items below shipped or changed support status.
> Use [`../proposed-next-steps.md`](../proposed-next-steps.md) for the current short roadmap.
...
[retired investigation architecture](deep-hunt-architecture.md).
